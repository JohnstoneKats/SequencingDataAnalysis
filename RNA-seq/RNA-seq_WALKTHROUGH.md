...
[2_Hisat2_Mouse_SE.sbatch](2_Hisat2_Mouse_SE.sbatch)
```
module load hisat2
...
[3_RNAseQC.sbatch](3_RNAseQC.sbatch)
```
...
[4_featureCounts.sbatch](4_featureCounts.sbatch)
```
module load subread
...
[5_RNA_Seq_Analysis.R](5_RNA_Seq_Analysis.R)
```
